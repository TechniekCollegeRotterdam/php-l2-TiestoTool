...
<html lang="en">
  ...
  <ul class="dropdown-menu">
    ...
    <a href="afspeellijst.php" class="btn btn-danger">terug</a>
    </div>
    <div class="card-body">

    <form action="CRUD_afspeellijsttoevoegen.php" method="POST">
  <div class="mb-3">
    <label for="name" class="form-label">name</label>
    <input type="text" name="name" class="form-control" id="name">
  
  <button type="submit" name="add_name" class="btn btn-success">Submit</button>
</form>
    </div>
    </div>
